...
var TypeaheadDirective = (function () {
    ...
    TypeaheadDirective.prototype.ngOnInit = function () {
        ...
        if (this.typeaheadAsync === undefined && !(this.typeahead instanceof Rx_1.Observable)) {
            this.typeaheadAsync = false;
        }
        if (this.typeahead instanceof Rx_1.Observable) {
    ...
    TypeaheadDirective.prototype.syncActions = function () {
        ...
        this.keyUpEventEmitter
            ...
            return Rx_1.Observable.from(_this.typeahead)
    ...
    TypeaheadDirective = __decorate([
        ...
        __metadata('design:paramtypes', [forms_1.NgModel, core_1.ViewContainerRef, core_1.ElementRef, core_1.Renderer, core_1.DynamicComponentLoader])
    ], TypeaheadDirective);
