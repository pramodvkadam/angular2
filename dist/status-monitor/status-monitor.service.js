...
var StatusService = (function () {
    function StatusService(_http, _config) {
        ...
        if (user) {
            ...
            this._services$ = new Subject_1.Subject();
        }
    }
    //get logs$() {
    //    return this._logs$.asObservable();
    //}
    StatusService.prototype.getAllServices = function () {
        var _this = this;
        ...
        return this._http.get(this._apiUrl + "/services", { headers: headers })
            ...
            return _this._services$ = response;
        }, function (error) { return console.log('Could not load logs.'); });
    };
    StatusService.prototype.getAllApplicationSources = function () {
        var headers = new http_1.Headers({
            Authorization: this._header_auth
        });
